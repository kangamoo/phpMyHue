...
if (!isset($selruleid) or $selruleid == "") {
	...
	if (!isset($simplemode)) {
		include 'include/rd_advanced.php';
	}
	...
	echo "&nbsp;";
	if (isset($advmode)) {
		echo "<BUTTON ID=simplemod>" . $trs["Simple_mode"] . "</BUTTON>";
	}
	if (isset($simplemode)) {
		echo "<BUTTON ID=advmod>" . $trs["Advanced_mode"] . "</BUTTON>";
	}
